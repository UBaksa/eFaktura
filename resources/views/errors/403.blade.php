...
<head>
    ...
    <title>eFaktura - Pristup odbijen</title>
    @vite(['resources/css/app.css', 'resources/js/app.js'])
</head>
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
    <div class="text-center px-6">
        <div class="text-9xl font-black text-red-600 mb-4">403</div>
        <div class="w-24 h-1 bg-yellow-400 mx-auto mb-6"></div>
        <h1 class="text-3xl font-bold text-gray-900 mb-4">Pristup odbijen</h1>
        <p class="text-gray-500 mb-8 max-w-md mx-auto">
            Nemate dozvolu za pristup ovoj stranici. 
            Ukoliko smatrate da je ovo greška, kontaktirajte administratora.
        </p>
